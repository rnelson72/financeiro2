...
<div class="accordion" id="accordionControles">
        ...
        <ul class='list-group list-group-flush'>
          ...
          <li class='list-group-item d-flex justify-content-between align-items-center'>
            ...
            <div class="d-flex align-items-center gap-2">
              ...
              <a href="?path=controle_lancamentos&id=<?= $ctrl['id'] ?>" class="btn btn-sm btn-outline-secondary" title="Ver Lançamentos"><i class="bi bi-list-ul"></i></a>
              <a href="?path=controle_editar&id=<?= $ctrl['id'] ?>" class="btn btn-sm btn-outline-primary" title="Editar"><i class="bi bi-pencil-square"></i></a>
              <a href="?path=controle_excluir&id=<?= $ctrl['id'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Deseja excluir este controle?')"><i class="bi bi-trash"></i></a>
            </div>
          </li>
          <?php endforeach; ?>
        </ul>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="grupo-desativados">
      <button class="accordion-button collapsed bg-dark text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-desativados">
